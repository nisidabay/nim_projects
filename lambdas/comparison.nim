## Module: comparison - autogenerated documentation placeholder
...
# Named procedure
## findOdd - description placeholder
...
## checkOdd - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## checkLambda - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
