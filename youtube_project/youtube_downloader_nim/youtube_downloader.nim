...
const DOWNLOAD_FOLDER = "/mnt/sata/Downloads"
...
proc interactiveMode() =
  echo "🎯 Nim YouTube Downloader - Interactive Mode"
  echo "=".repeat(50)
  ...
  while true:
    ...
    echo "1. 🎥 Single video/audio"
    echo "2. 📁 Entire playlist"
    echo "3. ℹ️  Get video info only"
    echo "4. 🔙 Enter new URL"
    ...
    of "2":
      ...
      # ---
      echo ""
      echo "📁 Configuring playlist download..."
      let (format, quality, outputFormat) = promptForFormatAndQuality()
      discard downloader.downloadPlaylist(url, format, quality, outputFormat)

    of "3":
      echo ""
      echo "ℹ️ Fetching video information..."
