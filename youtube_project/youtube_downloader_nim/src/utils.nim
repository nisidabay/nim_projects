## Module: utils - autogenerated documentation placeholder

import std/[os, strutils, terminal, strformat]

## createDirIfNotExists - description placeholder
...
## sanitizeFilename - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## formatDuration - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## formatFileSize - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## printSuccess - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## printError - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## printWarning - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## printInfo - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
...
## printProgress - description placeholder
## Params: (add parameters description)
## Returns: (add return description)
